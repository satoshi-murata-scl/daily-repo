...
INSERT INTO "new_Store" ("appBaseUrl", "createdAt", "id", "lineNotifyToken", "maxStaff", "name", "pdfUrl", "reminderEnabled", "reminderTime", "statement", "statementTitle", "storeCode") SELECT "appBaseUrl", "createdAt", "id", "lineNotifyToken", "maxStaff", "name", "pdfUrl", "reminderEnabled", "reminderTime", "statement", "statementTitle", "storeCode" FROM "Store";
DROP TABLE "Store";
